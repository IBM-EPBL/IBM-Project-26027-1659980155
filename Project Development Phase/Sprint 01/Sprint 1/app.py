...
def agentprofileinfo():
    if 'loggedin' in session:
        ...
        msg6 = msg4 - msg5
        msg8 = msg3
        return render_template('userprofile.html',msg1 = msg1,msg2=msg2,msg3 = msg3, msg4 = msg4,msg5=msg5, msg6=msg6, msg7=msg7, msg8=msg8, username=session['AGENTUSERNAME'])
    return redirect(url_for('userlog'))
